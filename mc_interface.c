...
void mc_interface_set_duty(float dutyCycle) {
	debug_print("mc_if_set_duty \r\n", 17);
	if (mc_interface_try_input()) {
		debug_print("No motors \r\n", 11);
		//return;
	}
...
void mc_interface_set_duty_noramp(float dutyCycle) {
	debug_print_ex("mc_if_set_duty_noramp\r\n");
	if (mc_interface_try_input()) {
		return;
	}
...
void mc_interface_set_pid_speed(float rpm) {
	debug_print_ex("mc_if_set_pid_speed\r\n");
	if (mc_interface_try_input()) {
		return;
	}
...
void mc_interface_set_pid_pos(float pos) {
	debug_print_ex("mc_if_set_pid_pos\r\n");
	if (mc_interface_try_input()) {
		return;
	}
...
void mc_interface_set_current(float current) {
	debug_print_ex("mc_if_set_current\r\n");
	if (mc_interface_try_input()) {
		return;
	}
...
void mc_interface_set_handbrake(float current) {
	debug_print_ex("mc_if_set_handbrake\r\n");
	if (mc_interface_try_input()) {
		return;
	}
